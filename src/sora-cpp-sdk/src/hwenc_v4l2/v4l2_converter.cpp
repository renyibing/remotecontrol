...
int V4L2DecodeConverter::Init(int src_pixelformat, bool dst_export_dmafds) {
  ...
  runner_ = V4L2Runner::Create(
      ...
      V4L2_MEMORY_MMAP,
      // Called when the image size changes.
      [this, dst_export_dmafds]() {
        // Stop all streams and clear the buffers.
        ...
        // Get the new size of the decoded image.
        v4l2_format dst_fmt = {};
        ...
        // Recreate the capture buffer and queue it.
