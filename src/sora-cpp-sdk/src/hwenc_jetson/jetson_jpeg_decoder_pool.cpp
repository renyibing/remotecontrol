...
std::shared_ptr<JetsonJpegDecoder> JetsonJpegDecoderPool::Pop() {
  ...
  // In JetPack 5.1.2, the same frame is continuously sent, so the queue is disabled
  // In JetPack 5.1.1, it worked normally
  // PR for the same problem in momo: https://github.com/shiguredo/momo/pull/297/
  // {
