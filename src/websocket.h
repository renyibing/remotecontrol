...
// SSL+client, non-SSL+client, server can be treated similarly.
//
// You can call WriteText from any thread to write, and you may call
// the next WriteText without waiting for the previous write's completion callback.
class Websocket {
 public:
 ...
 public:
  ...
  // HTTP Proxy + SSL client (with SSL and HTTP proxy)
